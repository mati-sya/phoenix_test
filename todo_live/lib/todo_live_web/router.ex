defmodule TodoLiveWeb.Router do
  ...
  import TodoLiveWeb.AccountAuth
  ...
  scope "/", TodoLiveWeb do
    ...
    live_session :redirect_if_account_is_authenticated,
      on_mount: [{TodoLiveWeb.AccountAuth, :redirect_if_account_is_authenticated}] do
  ...
  scope "/", TodoLiveWeb do
    ...
    live_session :current_account,
      on_mount: [{TodoLiveWeb.AccountAuth, :mount_current_account}] do
