defmodule TodoLiveWeb.AccountAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_todo_live_web_account_remember_me"
  ...
  def log_out_account(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TodoLiveWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_account:
      ...
      defmodule TodoLiveWeb.PageLive do
        use TodoLiveWeb, :live_view

        on_mount {TodoLiveWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TodoLiveWeb.AccountAuth, :ensure_authenticated}] do
