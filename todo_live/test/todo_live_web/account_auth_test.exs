defmodule TodoLiveWeb.AccountAuthTest do
  use TodoLiveWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias TodoLive.Accounts
  alias TodoLiveWeb.AccountAuth
  import TodoLive.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TodoLiveWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TodoLiveWeb.Endpoint.subscribe(live_socket_id)
